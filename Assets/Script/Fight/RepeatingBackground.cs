...
public class RepeatingBackground : MonoBehaviour {
    ...
    private static float sizeOfBackground = 24f;
    ...
    private void Update()
    {
        ...
        if (transform.position.x + groundHorizontalLength +20f < FightManager.currPlayer.transform.position.x)
        {
    ...
    private void RepositionBackground()
    {
        ...
        Vector2 groundOffSet = new Vector2(groundHorizontalLength * 4f + 24f, 0);// sizeOfBackground = 24f but collider 11f
